...
if var >= 8 and var <= 12:
    print('Well done! BEEF emits around 10 times more carbon dioxide then CHICKEN.')
    time.sleep(0.5)
    pts=pts+1
else:
...
if var >= 2 and var <= 5:
    print('Well done! DARK CHOCOLATE emits around 3.4 times more carbon dioxide then CHICKEN.')
    time.sleep(0.5)
    pts=pts+1
else:
...
if var >= 9 and var <= 13:
    print('Well done! DARK CHOCOLATE emits around 11.3 times more carbon dioxide then TOFU.')
    time.sleep(0.5)
    pts=pts+1
else:
